...
(function () { "use strict";
var Case11 = function() { };
Case11.main = function() {
	var src = _$Pipeline_Pipeline_$Impl_$.open([{ name : "tom", age : 20},{ name : "alice", age : 21},{ name : "bob", age : 24},{ name : "xyz", age : 25}]);
	if(!_$Pipeline_Pipeline_$Impl_$.any(src,function(x) {
		return x.name == "tom";
	})) {
		console.log("failed");
	}
	if(!(!_$Pipeline_Pipeline_$Impl_$.any(_$Pipeline_Pipeline_$Impl_$.where(src,function(x1) {
		return x1.name != "tom";
	}),function(x2) {
		return x2.name == "tom";
	}))) {
	...
	if(!_$Pipeline_Pipeline_$Impl_$.all(src,function(x3) {
		return x3.age >= 20;
	})) {
		console.log("failed");
	}
	if(!(!_$Pipeline_Pipeline_$Impl_$.all(src,function(x4) {
		return x4.name.length <= 3;
	}))) {
		console.log("failed");
	}
};
