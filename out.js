...
(function () { "use strict";
var Case13 = function() { };
Case13.main = function() {
	var itr = $iterator(_$Pipeline_Pipeline_$Impl_$)(_$Pipeline_Pipeline_$Impl_$.skip(_$Pipeline_Pipeline_$Impl_$.enumerate(0,10),3));
	var _g = 3;
	while(_g < 10) {
		var i = _g++;
	...
	itr = $iterator(_$Pipeline_Pipeline_$Impl_$)(_$Pipeline_Pipeline_$Impl_$.limit(_$Pipeline_Pipeline_$Impl_$.enumerate(0,10),5));
	var _g1 = 0;
	while(_g1 < 5) {
		var i1 = _g1++;
		if(!(itr.hasNext() && i1 == itr.next())) {
			console.log("failed");
		}
	}
	if(!(!itr.hasNext())) {
	...
	itr = $iterator(_$Pipeline_Pipeline_$Impl_$)(_$Pipeline_Pipeline_$Impl_$.limit(_$Pipeline_Pipeline_$Impl_$.skip(_$Pipeline_Pipeline_$Impl_$.enumerate(0,10),3),3));
	var _g2 = 3;
	while(_g2 < 6) {
		var i2 = _g2++;
		if(!(itr.hasNext() && i2 == itr.next())) {
			console.log("failed");
		}
	}
	if(!(!itr.hasNext())) {
